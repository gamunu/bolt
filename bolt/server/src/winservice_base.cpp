...
/// </summary>
WBServiceBase *WBServiceBase::s_service = NULL;
...
/// </summary>
/// <param name="service">the reference to a CServiceBase object. It will become the
/// singleton service instance of this service application.</param>
/// <returns>
/// If the function succeeds, the return value is TRUE. If the
/// function fails, the return value is FALSE. To get extended error
/// information, call GetLastError.
/// </returns>
BOOL WBServiceBase::Run(WBServiceBase &service)
{
	s_service = &service;
...
/// <param name="pszArgv">array of command line arguments.</param>
void WINAPI WBServiceBase::ServiceMain(DWORD dwArgc, PWSTR *pszArgv)
{
...
/// <summary>
/// The function is called by the SCM whenever a control code is
/// sent to the service.
/// </summary>
/// <param name="dwCtrl">
/// the control code. This parameter can be one of the
/// following values:
...
///  to 255.
/// </param>
void WINAPI WBServiceBase::ServiceCtrlHandler(DWORD dwCtrl)
{
	switch (dwCtrl)
	{
...
/// <summary>
/// The constructor of <see cref="BServiceBase"/>. It initializes a new instance
...
/// shutdown occurs.
/// </summary>
/// <param name="pszServiceName">the name of the service.</param>
/// <param name="fCanStop">the service can be stopped.</param>
/// <param name="fCanShutdown">the service is notified when system shutdown occurs.</param>
/// <param name="fCanPauseContinue">the service can be paused and continued.</param>
WBServiceBase::WBServiceBase(PWSTR pszServiceName,
	BOOL fCanStop,
	BOOL fCanShutdown,
...
/// <summary>
/// The virtual destructor of <see cref="BServiceBase"/>.
/// </summary>
WBServiceBase::~WBServiceBase(void)
{
}
...
/// <summary>
/// The function starts the service. It calls the OnStart virtual
...
/// <param name="dwArgc">number of command line arguments.</param>
/// <param name="pszArgv">array of command line arguments.</param>
void WBServiceBase::Start(DWORD dwArgc, PWSTR *pszArgv)
{
	try
	{
...
/// <param name="dwArgc">number of command line arguments.</param>
/// <param name="pszArgv">array of command line arguments.</param>
void WBServiceBase::OnStart(DWORD dwArgc, PWSTR *pszArgv)
{
}

/// <summary>
/// The function stops the service. It calls the OnStop virtual
/// function in which you can specify the actions to take when the service
...
/// <summary>
/// The function sets the service status and reports the status to
/// the SCM.
/// </summary>
...
void WBServiceBase::SetServiceStatus(DWORD dwCurrentState,
...
/// </summary>
/// <param name="pszMessage">string message to be logged.</param>
/// <param name="wType">
/// the type of event to be logged. The parameter can be one of
...
/// </param>
void WBServiceBase::WriteEventLogEntry(PWSTR pszMessage, WORD wType)
{
...
/// </summary>
/// <param name="pszFunction">the function that gives the error.</param>
/// <param name="dwError">the error code.</param>
void WBServiceBase::WriteErrorLogEntry(PWSTR pszFunction, DWORD dwError)
{
